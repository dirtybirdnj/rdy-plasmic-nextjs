...
export type RobotBlack24DpsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function RobotBlack24DpsvgIcon(props: RobotBlack24DpsvgIconProps) {
...
export default RobotBlack24DpsvgIcon;
/* prettier-ignore-end */
