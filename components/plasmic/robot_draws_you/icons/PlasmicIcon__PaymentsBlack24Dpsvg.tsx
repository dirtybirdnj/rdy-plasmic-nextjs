...
export type PaymentsBlack24DpsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PaymentsBlack24DpsvgIcon(props: PaymentsBlack24DpsvgIconProps) {
...
export default PaymentsBlack24DpsvgIcon;
/* prettier-ignore-end */
