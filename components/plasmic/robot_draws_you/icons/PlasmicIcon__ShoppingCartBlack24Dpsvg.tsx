...
export type ShoppingCartBlack24DpsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ShoppingCartBlack24DpsvgIcon(
  props: ShoppingCartBlack24DpsvgIconProps
) {
...
export default ShoppingCartBlack24DpsvgIcon;
/* prettier-ignore-end */
