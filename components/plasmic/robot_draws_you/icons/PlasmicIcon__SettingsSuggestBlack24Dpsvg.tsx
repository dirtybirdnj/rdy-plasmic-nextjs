...
export type SettingsSuggestBlack24DpsvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function SettingsSuggestBlack24DpsvgIcon(
  props: SettingsSuggestBlack24DpsvgIconProps
) {
...
export default SettingsSuggestBlack24DpsvgIcon;
/* prettier-ignore-end */
