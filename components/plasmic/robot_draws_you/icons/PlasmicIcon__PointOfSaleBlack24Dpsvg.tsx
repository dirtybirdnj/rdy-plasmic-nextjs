...
export type PointOfSaleBlack24DpsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PointOfSaleBlack24DpsvgIcon(
  props: PointOfSaleBlack24DpsvgIconProps
) {
...
export default PointOfSaleBlack24DpsvgIcon;
/* prettier-ignore-end */
